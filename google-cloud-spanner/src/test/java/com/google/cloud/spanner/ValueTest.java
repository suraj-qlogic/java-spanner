...
public class ValueTest {
  ...
  public void int64TryGetBool() {
    ...
    try {
      ...
      assertTrue(e.getMessage().contains("Expected: BOOL actual: INT64"));
    }
  }
  ...
  public void int64TryGetInt64Array() {
    ...
    try {
      ...
      assertTrue(e.getMessage().contains("Expected: ARRAY<INT64> actual: INT64"));
    }
  }
  ...
  public void commitTimestamp() {
    ...
    try {
      ...
      assertTrue(e.getMessage().contains("Commit timestamp value"));
    }
  }
  ...
  public void boolArrayTryGetInt64Array() {
    ...
    try {
      ...
      assertTrue(e.getMessage().contains("Expected: ARRAY<INT64> actual: ARRAY<BOOL>"));
    }
  }
  ...
  public void int64ArrayTryGetBool() {
    ...
    try {
      ...
      assertTrue(e.getMessage().contains("Expected: BOOL actual: ARRAY<INT64>"));
    }
  }
  ...
  public void float64ArrayTryGetInt64Array() {
    ...
    try {
      ...
      assertTrue(e.getMessage().contains("Expected: ARRAY<INT64> actual: ARRAY<FLOAT64>"));
    }
  }
  ...
  public void stringArrayTryGetBytesArray() {
    ...
    try {
      ...
      assertTrue(e.getMessage().contains("Expected: ARRAY<BYTES> actual: ARRAY<STRING>"));
    }
  }
  ...
  public void bytesArrayTryGetStringArray() {
    ...
    try {
      ...
      assertTrue(e.getMessage().contains("Expected: ARRAY<STRING> actual: ARRAY<BYTES>"));
    }
  }
  ...
  public void struct() {
    ...
    try {
      ...
      assertTrue(e.getMessage().contains("Mismatch between struct value and type."));
    }
  }
  ...
  public void nullStruct() {
    ...
    try {
      ...
      assertTrue(e.getMessage().contains("Illegal call to create a NULL struct value."));
    }
  }
  ...
  public void nullStructGetter() {
    ...
    try {
      ...
      assertTrue(e.getMessage().contains("Illegal call to getter of null value."));
    }
  }
  ...
  public void structArrayInvalidType() {
    ...
    try {
      ...
      assertTrue(e.getMessage().contains("must have type STRUCT<ff1 STRING, ff2 INT64>"));
    }
  }
